...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const fallbackImage = "https://media.licdn.com/dms/image/C5112AQEw1fXuabCTyQ/article-inline_image-shrink_1500_2232/0/1581099611064?e=1723680000&v=beta&t=6S7bXe8qcAUiZCnFACgstd7VYU-DRwz4Zz1OTtyjNU8";

  return {
    title: `${project.name} | Project`,
    metadataBase: new URL(`https://anshmodi.tech/projects/${project.slug}`),
    description: project.tagline,
    openGraph: {
      images: project.coverImage
        ? urlFor(project.coverImage.image).width(1200).height(630).url()
        : fallbackImage,
      url: `https://anshmodi.tech/projects/${project.slug}`,
      title: project.name,
      description: project.tagline,
    },
  };
