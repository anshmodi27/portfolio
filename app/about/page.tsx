...
export const metadata: Metadata = {
  title: "About | Ansh Modi",
  metadataBase: new URL("https://anshmodi.tech/about"),
  description:
    "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | Ansh Modi",
    url: "https://anshmodi.tech/about",
    description:
      "Learn more about my skills, experience and technical background",
  },
};
                  ...
                  <div className="sticky top-10">
                    ...
                    <div className="flex flex-col text-center gap-y-4">
                      <div className="flex items-center gap-x-3">
                        <RefLink
                          href="https://drive.google.com/file/d/1wC0r0qeJ5j3nHVtXLP7-gKRBF2hdTL7g/view?usp=drive_link"
